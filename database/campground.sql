...
CREATE TABLE campground (
  ...
  CONSTRAINT fk_campground_park_id_park_park_id FOREIGN KEY (park_id) REFERENCES park (park_id)
);
...
CREATE TABLE site (
  ...
  CONSTRAINT fk_site_campground_id_campgrounds_campground_id FOREIGN KEY (campground_id) REFERENCES campground(campground_id)
);
...
CREATE TABLE reservation (
  ...
  CONSTRAINT fk_reservation_site_id_site_site_id FOREIGN KEY (site_id) REFERENCES site (site_id)
...
SELECT setval(pg_get_serial_sequence('reservation', 'reservation_id'), 44);
